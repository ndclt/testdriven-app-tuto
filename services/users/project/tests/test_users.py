...
class TestUserService(BaseTestCase):
    ...
    def test_single_user(self):
        ...
        user = add_user('nd', 'nd@mherman.org', 'greaterthaneight')
        with self.client:
            response = self.client.get(f'/users/{user.id}')
            data = json.loads(response.data.decode())
            self.assertEqual(response.status_code, 200)
            self.assertIn('nd', data['data']['username'])
            self.assertIn('nd@mherman.org', data['data']['email'])
            self.assertIn('success', data['status'])
    ...
    def test_all_users(self):
        ...
        add_user('nd', 'nd@mherman.org', 'greaterthaneight')
        add_user('nc', 'nc@notreal.org', 'greaterthaneight')
        with self.client:
    ...
    def test_main_with_users(self):
        ...
        with self.client:
            ...
            self.assertIn(b'nd', response.data)
            self.assertIn(b'nc', response.data)
    ...
    def test_main_add_user(self):
        ...
        with self.client:
            response = self.client.post(
                '/',
                data=dict(username='nd', email='nd@mherman.org',
                          password='greaterthaneight'),
